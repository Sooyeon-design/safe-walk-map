  ...
  return (
    <div className="flex min-h-dvh w-full justify-center bg-white">
      <div className="relative flex min-h-dvh w-full max-w-[375px] flex-col bg-white">
        {/* 지도 영역: Figma 375×812 기준 지도 영역 높이(812 - 하단 시트 412 = 400px)를 최소값으로 유지 */}
        ...
        {/* 하단 바텀시트 */}
        <div className="z-10 flex flex-col gap-[24px] bg-white p-[16px] drop-shadow-[0px_4px_12px_rgba(0,0,0,0.25)]">
